 ...
 * exist, the same shape as DEPLOYMENT.md §5bis's `setWebhook` step and meant
 ...
 * DEPLOYMENT.md §5bis carries the same list so the two stay in sync by hand.
 */
...
/* Keep this list identical to the branches `webhook/route.ts` actually
   handles, and to DEPLOYMENT.md §5bis's copy of it — Telegram will happily
