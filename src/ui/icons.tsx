...
const PATHS = {
  ...
  bed: [
    'M2.5 20v-8a2 2 0 0 1 2-2h15a2 2 0 0 1 2 2v8',
    'M2.5 16h19',
    'M6.5 10V7.2a1.2 1.2 0 0 1 1.2-1.2h8.6a1.2 1.2 0 0 1 1.2 1.2V10',
  ],

  /* --- amenity glyphs, keyed by amenity.icon --- */
  wifi: [
    'M2.6 9.2a15 15 0 0 1 18.8 0',
    'M6 12.6a10 10 0 0 1 12 0',
    'M9.4 16a5 5 0 0 1 5.2 0',
    'M12 19.4h.01',
  ],
  ...
  flame: [
    'M12 21a6 6 0 0 0 6-6c0-4.2-3.1-5.6-3.6-9.6-2 1.5-3 3.6-3 5.6C10.2 9.2 9.2 7.6 9.2 7.6S6 10 6 15a6 6 0 0 0 6 6Z',
  ],
  ...
  coffee: [
    'M5 8h11v5.2A5.5 5.5 0 0 1 5 13.2Z',
    'M16 9.2h1.8a2.2 2.2 0 0 1 0 4.4H16',
    'M4 20.5h13',
    'M8 3.6v1.8M12 3.6v1.8',
  ],
  washer: [
    'M5 3.5h14A1.5 1.5 0 0 1 20.5 5v14a1.5 1.5 0 0 1-1.5 1.5H5A1.5 1.5 0 0 1 3.5 19V5A1.5 1.5 0 0 1 5 3.5Z',
    'M3.5 8h17',
  ...
  bath: [
    'M4 12.5h16v2.6a4 4 0 0 1-4 4H8a4 4 0 0 1-4-4Z',
    'M6.6 12.5V6.6A2.6 2.6 0 0 1 9.2 4h.2a2.6 2.6 0 0 1 2.6 2.6',
    'm7 19.1-1 2M17 19.1l1 2',
  ],
  shower: ['M5 21v-9.5a4.5 4.5 0 0 1 4.5-4.5', 'm13.4 4.2 5.4 5.4', 'M9.5 14h.01M12.5 16.4h.01M15.5 14h.01'],
  soap: [
    'M7 10.2h10V19a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2Z',
    'M10 10.2V6.6A1.6 1.6 0 0 1 11.6 5h1A1.6 1.6 0 0 1 14.2 6.6v3.6',
    'M10 15h4',
  ],
  towel: [
    'M6 3h12a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H6a3 3 0 0 1-3-3V6a3 3 0 0 1 3-3Z',
    'M6 3a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3',
  ],
  desk: ['M4 6.6A1.6 1.6 0 0 1 5.6 5h12.8A1.6 1.6 0 0 1 20 6.6V16H4Z', 'M2 19h20'],
  tv: [
    'M4 7.6h16A1.6 1.6 0 0 1 21.6 9.2v7.6A1.6 1.6 0 0 1 20 18.4H4a1.6 1.6 0 0 1-1.6-1.6V9.2A1.6 1.6 0 0 1 4 7.6Z',
    'm8 3 4 4 4-4',
  ],
  ...
  phone: [
    'M7.5 3h9A1.5 1.5 0 0 1 18 4.5v15a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 6 19.5v-15A1.5 1.5 0 0 1 7.5 3Z',
    'M10.4 17.4h3.2',
  ],
  ...
  extinguisher: [
    'M9.2 8.4h4.6V20a1 1 0 0 1-1 1h-2.6a1 1 0 0 1-1-1Z',
    'M10.4 8.4V6.4a1.6 1.6 0 0 1 3.2 0v2',
    'M13.8 10.6h3.4l1-3.2',
  ],
  kit: [
  ...
  noSmoking: [
    'M3.5 15.6h12.4v3H3.5Z',
    'M18.2 15.6h2.3v3h-2.3Z',
    'M16.8 12.6a3.1 3.1 0 0 0 0-6.2',
    'M4 20 20 4',
  ],
  paw: [
  ...
  /* --- dashboard nav (0019) --- */
  wallet: [
    'M5.5 8h13A1.5 1.5 0 0 1 20 9.5v8a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 17.5v-8A1.5 1.5 0 0 1 5.5 8Z',
    'M4 8V6.5A1.5 1.5 0 0 1 5.5 5h9',
    'M15.7 13.4a1.1 1.1 0 1 0 0 2.2 1.1 1.1 0 0 0 0-2.2Z',
  ],
  user: [
    'M17.5 20v-1.3a4.5 4.5 0 0 0-4.5-4.5h-2a4.5 4.5 0 0 0-4.5 4.5V20',
    'M12 12a3.7 3.7 0 1 0 0-7.4 3.7 3.7 0 0 0 0 7.4',
  ],
} as const;
...
export function amenityCategoryLabel(key: string, locale: 'ru' | 'be' | 'en'): string {
  const table =
    locale === 'be' ? AMENITY_CATEGORY_LABEL_BE : locale === 'en' ? AMENITY_CATEGORY_LABEL_EN : null;
